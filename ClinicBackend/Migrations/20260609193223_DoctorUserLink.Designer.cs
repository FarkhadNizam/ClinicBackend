...
namespace ClinicBackend.Migrations
{
    ...
    [Migration("20260609193223_DoctorUserLink")]
    partial class DoctorUserLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClinicBackend.Models.Diagnosis", b =>
                {
            ...
            modelBuilder.Entity("ClinicBackend.Models.Doctor", b =>
                {
                    ...
                    b.Property<int>("PlannedWeeklyHours")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClinicBackend.Models.Specialty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClinicBackend.Models.WaitingListEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClinicBackend.Models.Doctor", b =>
                {
                    b.HasOne("ClinicBackend.Models.Specialty", "Specialty")
                        .WithMany()
                        .HasForeignKey("SpecialtyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClinicBackend.Models.User", null)
                        .WithOne("Doctor")
                        .HasForeignKey("ClinicBackend.Models.Doctor", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ClinicBackend.Models.MedicalVisit", b =>
                {
                    ...
                    b.HasOne("ClinicBackend.Models.Diagnosis", "Diagnosis")
                        .WithMany()
